...
const OFFICIAL = "https://www.gambu.edu.et";
...
export const gambella: UniversityRecord = {
  university: {
    ...
    shortName: "GamU",
    amharicName: "ጋምቤላ ዩኒቨርሲቲ",
    alternateNames: ["GamU", "Gambella", "ጋምቤላ"],
    type: "Public University",
    regionId: "gambela",
    city: "Gambella",
    country: "Ethiopia",
    address: "Gambela, Gambela Region, Ethiopia",
    coordinates: null,
    googleMapsUrl: null,
    generationId: "gen-3",
    yearEstablished: "2011",
    overview:
      "Gambella University is a non-profit public coeducational higher education institution located in the small city of Gambela, Gambela Region, Ethiopia. Recognized by the Ministry of Education of Ethiopia, it provides programs and courses leading to officially recognized higher education degrees in several areas of study.",
    mission: null,
    vision: null,
    values: [],
    goals: [],
  ...
  history: [
    {
      ...
      year: "2011",
      title: "Founded",
      description: "Current dataset reports 2011; a third-party profile reports 2015.",
  ...
  sources: [
    {
      id: `${uid}-s1`,
      universityId: uid,
      sourceName: "Gambella University official website",
      sourceUrl: OFFICIAL,
  ...
  socialPlatforms: [],
  dataNotes: [
    "Spelling noted: the third-party profile uses 'Gambela'; this dataset uses 'Gambella'.",
    "A third-party profile reports the establishment year as 2015; this dataset records 2011. Both are shown rather than merged.",
