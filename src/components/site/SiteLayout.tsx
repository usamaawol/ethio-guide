    ...
    <div className="flex min-h-screen flex-col bg-background">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <span className="leading-tight">
              <span className="block text-sm font-bold text-foreground">University Guide</span>
              <span className="block text-[11px] text-muted-foreground">for Ethiopian students</span>
            </span>
          </Link>
      ...
      <footer className="border-t border-border bg-secondary/40">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-3 lg:px-8">
          <div>
            <p className="text-sm font-bold text-foreground">University Guide 🇪🇹</p>
            <p className="mt-2 text-sm text-muted-foreground">
              An independent discovery platform for Ethiopian higher education. Information is shown
              only when it can be traced to an official source.
            </p>
          </div>
          <div>
        ...
        <div className="border-t border-border py-4 text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} University Guide for Ethiopian Students
        </div>
      </footer>
    </div>
  );
